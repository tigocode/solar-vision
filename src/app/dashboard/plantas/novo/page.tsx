...
import {
   CheckCircle2, ChevronRight, ChevronLeft, FileText, Package, Truck, BarChart3, Layers,
   Cpu, Award, UploadCloud, FileImage, Lock, Plus, Trash2, CalendarDays, Factory
} from 'lucide-react';
import { ProjectStatus, AssetType } from '@/types/plants';
import { getStoredProjects, saveProjectFlow, SolarProjectFlow } from '@/utils/storage';
